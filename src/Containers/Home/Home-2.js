                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.right}>
                        <div className={styles.buttonsRight}>
                            ...
                            <a href='https://github.com/Isomkevin/ChainRivals/commits/main' target="_blank" rel="noreferrer"><button className={styles.cta} aria-label="Open commit log">
                            ...
                            <a href="https://github.com/Isomkevin/ChainRivals/blob/main/README.md#sources" target="_blank" rel="noreferrer"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="View Sources">
