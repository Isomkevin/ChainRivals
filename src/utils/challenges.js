const challenges = [
    ...
    },
    {
        ...
        link: 'https://2k.com/en-US/challenge/bioshock-infinite/',
    ...
    },
    {
        ...
        link: 'https://www.rockstarchallenges.com/reddeadredemption2',
    ...
    },
    {
        ...
        surname: "gtav",
        price: "39.99",
        desc: 'Grand Theft Auto V is a vast open world challenge set in Los Santos, a sprawling sun-soaked metropolis struggling to stay afloat in an era of economic uncertainty and cheap reality TV. The challenge blends storytelling and challengeplay in new ways as players repeatedly jump in and out of the lives of the challenges three lead characters, playing all sides of the challenges interwoven story.',
        link: 'https://www.rockstarchallenges.com/gta-v',
    ...
    },
    {
        ...
        surname: "minecraft",
        price: "25.99",
        desc: 'Minecraft focuses on allowing the player to explore, interact with, and modify a dynamically-generated map made of one-cubic-meter-sized blocks. In addition to blocks, the environment features plants, mobs, and items. Some activities in the challenge include mining for ore, fighting hostile mobs, and crafting new blocks and tools by gathering various resources found in the challenge. The challenges open-ended model allows players to create structures, creations, and artwork on various multiplayer servers or their single-player maps. Other features include redstone circuits for logic computations and remote actions, minecarts and tracks, and a mysterious underworld called the Nether. A designated but completely optional goal of the challenge is to travel to a dimension called the End, and defeat the ender dragon.',
    ...
    },
    {
        ...
        price: "12.99",
        desc: 'Rise of the Tomb Raider is a third-person action-adventure challenge in which players control Lara Croft, who is on a quest to discover the legendary city of Kitezh. Combat is a major challengeplay mechanic; Lara has a large variety of weapons at her disposal (including assault rifles, shotguns, and pistols), some of which have an alternate firing mode. Players may also utilize stealth to progress through portions of the challenge, using bows and arrows to take out enemies, creating distractions to draw enemy attention away from Lara, or hiding in bushes to evade enemies. Lara can use the environment to fight enemies, shooting explosive barrels, tearing down rope-wrapped structures with rope arrows, or ambushing enemies from high ground. She can also use her ice axe and combat knife to engage in melee combat with enemies.',
        link: 'https://tombraider.square-enix-challenges.com/en-us',
    ...
    },
    {
        ...
        surname: "metro",
        price: "37.99",
        desc: 'Metro Exodus is an epic, story-driven first person shooter from 4A Games that blends deadly combat and stealth with exploration and survival horror in one of the most immersive challenge worlds ever created. Explore the Russian wilderness across vast, non-linear levels and follow a thrilling story-line that spans an entire year through spring, summer and autumn to the depths of nuclear winter. Inspired by the novels of Dmitry Glukhovsky, Metro Exodus continues Artyoms story in the greatest Metro adventure yet.',
        link: 'https://www.metrothechallenge.com/de/',
    ...
    },
    {
        ...
        link: 'https://fallout.bethesda.net/en/challenges/fallout-4',
        release: '10th of November, 2015',
    ...
    },
    {
        ...
        link: 'https://www.rockstarchallenges.com/challenges/sanandreas',
    ...
    },
    {
        ...
        price: "7.99",
        desc: 'Golf With Your Friends is an entertaining, challenging, multiplayer mini golf challenge for up to 12 players. The controls are simple and the challenge is designed for the user to be able to host or join a challenge within a few seconds. The challenge will be hosted on our servers where the user has the ability to add a password if so required or leave it open to the public. Players on PC, have the ability to access the level editor to create your own or test thousands of community made maps.',
    ...
    },
    {
        ...
        surname: "heavyrain",
        price: "23.99",
        desc: 'Heavy Rain is a cinematic psychological thriller from challenge developer Quantic Dream exclusively for the PlayStation 3. Dealing with a range of adult themes, the challenge revolves around a sophisticated plot and strong narrative threads that explore a complex moral proposition. You assume the role of multiple characters with very different backgrounds, motivations, and skills in a world where each player decision affects what will follow.',
    ...
    },
    {
        ...
        surname: "portal2",
        price: "44.99",
        desc: 'Sequel to the acclaimed Portal (2007), Portal 2 pits the protagonist of the original challenge, Chell, and her new robot friend, Wheatley, against more puzzles conceived by GLaDOS, an A.I. with the sole purpose of testing the Portal Guns mechanics and taking revenge on Chell for the events of Portal. As a result of several interactions and revelations, Chell once again pushes to escape Aperture Science Labs.',
    ...
    },
    {
        ...
        surname: "fifa",
        price: "15.99",
        desc: 'Powered by Football, FIFA 22 brings the challenge even closer to the real thing with fundamental challengeplay advances and a new season of innovation across every mode. Play with 17,000+ players, over 700 teams in 90+ stadiums and more than 30 leagues from all over the globe.',
        link: 'https://www.ea.com/de-de/challenges/fifa/fifa-22',
    ...
    },
    {
        ...
        surname: "halflife",
        price: "11.99",
        desc: '1998. HALF-LIFE sends a shock through the challenge industry with its combination of pounding action and continuous, immersive storytelling. By taking the suspense, challenge and visceral charge of the original, and adding startling new realism and responsiveness, Half-Life 2 opens the door to a world where the players presence affects everything around them, from the physical environment to the behaviors even the emotions of both friends and enemies.',
    ...
    },
    {
        ...
        surname: "twd",
        price: "6.99",
        desc: 'The Walking Dead: Season One (also known as The Walking Dead: The Game) is an episodic interactive drama graphic adventure video challenge developed and published by Telltale Games. Based on Robert Kirkmans The Walking Dead comic book series, the challenge consists of five episodes, released between April and November 2012. It is available for Android, iOS, Kindle Fire HDX, Microsoft Windows, Mac OS X, PlayStation 3, PlayStation Vita, Xbox 360, PlayStation 4 and Xbox One. The challenge is the first of The Walking Dead video challenge series published by Telltale.',
        link: 'http://www.thewalkingdeadchallenge.com/',
    ...
    },
    {
        ...
        price: "22.99",
        desc: 'Like its predecessors Crusader Kings and Crusader Kings II, Crusader Kings III is a grand strategy challenge and dynasty simulator set in the Middle Ages. Players begin as a character in either 867 or 1066. The challenge map is about four times more detailed than the one in Crusader Kings II and slightly larger, incorporating Europe, Africa roughly as far south as the Equator, and Asia as far East as Tibet. Upon the death or deposition of a players character they may continue to play as that characters heir. Overall, players develop a dynasty over the centuries, with the challenge ending in 1453.',
        link: 'https://www.paradoxinteractive.com/challenges/crusader-kings-iii/about',
    ...
    },
    {
        ...
        surname: "csgo",
        price: "4.99",
        desc: 'Counter-Strike: Global Offensive (CS:GO) is a first-person shooter video challenge which is a part of the Counter-Strike series. It was announced to the public on August 12, 2011, and is developed by Valve Corporation and their partner, Hidden Path Entertainment. The challenge was later released on August 21, 2012 for the Playstation 3, Xbox 360, Microsoft Windows, macOS and later Linux as a downloadable title.',
    ...
    },
    {
        ...
        surname: "tombraider",
        price: "17.99",
        desc: 'Tomb Raider (often referred to as: Tomb Raider: A Survivor is Born) is the tenth challenge in the Tomb Raider series and the first challenge in Crystal Dynamics second reboot of the challenge series. A new intense and gritty origin story of Lara Croft and her ascent from a frightened young woman to a hardened survivor. Armed only with raw instincts and the ability to push beyond the limits of human endurance, Lara must fight to unravel the dark history of a forgotten island to escape its relentless hold.',
        link: 'https://tombraider.square-enix-challenges.com/en-us',
